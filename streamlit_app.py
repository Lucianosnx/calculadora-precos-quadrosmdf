...
# Calcular e mostrar preço após markup
if width_cm and height_cm:
    area = width_cm * height_cm
    reference_area = 35 * 31
    base_price = (area * 8) / reference_area
    markup_price = base_price * markup_choices[markup]
    st.write(f"Preço após markup: R$ {markup_price:.2f}")
...
if width_cm and height_cm and markup and profit_margin:
    result = calculate_price(width_cm, height_cm, markup_choices[markup], profit_margin_choices[profit_margin], quantity, recurrence)
